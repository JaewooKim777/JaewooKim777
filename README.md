...
- 이종 연구 성과물 통합 기반의 Graph Transformer Network 응용 동명이인 판별 기법(창원대학교 R&D혁신본부 강사-대학원생-교원 간 융합연구 지원, 2403~2502)
- 스마트 동물병원 구축 및 스마트 진단을 위한 연구 논문 요약 서비스(LINC 3.0 사업단 3차년도 산학공동 기술개발과제/에스동물암센터, 2406~2412)
- 정부지원⸱공모사업 알리미 Ver1.0, AI알리미(AL-RIMI) 솔루션(알파에듀, 2401~2406)
- 2024년 스마트안전TBM Ver2.0, 알리지(AL-Easy) 솔루션(알파에듀⸱이노메스, 2401~2403)
- 빅데이터 플랫폼을 기반으로 한 연구 성과물의 동명이인 판별 및 연구 성과 분석(창원대학교 R&D혁신본부 강사-대학원생-교원 간 융합연구 지원, 2303~2402)
- 스마트 팩토리 현장 기반 빅데이터 및 인공지능 플랫폼 구축(울산⸱경남지역혁신플랫폼 스마트제조ICT사업단 2023년 수요맞춤형 기술공동 연구프로젝트 교육프로그램/신스윈, 2306~2401)
- 대용량 그래프 신경망 분석을 위한 분산 빅데이터 플랫폼 구축(울산⸱경남지역혁신플랫폼 5C LAB 과제/대보정보통신, 2210~2212) 
...
### Conference paper
- 박민철, 안진수, 김재우, 박민수, 이동영, 류연경, 서현우, 최도진, BERT 기반 사업 공고문 분류 모델(KCC2024, 2406)
...
- 김재우, 안진수, 유재수, 최도진, 다양한 딥러닝 모델을 활용한 GIS 부분 방전 유형 분류기(KCC2023, 2306)
- 안진수, 김재우, 유재수, 최도진, 군집 특성을 고려한 딥러닝 기반 창원시 누비자 서비스 이용자 수 예측(KCC2023, 2306)
- 박진우, 김재우, 박민철, 안진수, 유재수, 최도진, Spark를 활용한 대칭키 알고리즘(KCC2023, 2306)
- Jaewoo Kim, Jinsoo Ahn, Jeeyoon Kang, Sumin Lee, Dojin choi, Jaesoo Yoo, A Partial Discharge Classification Method Based on DNN in GIS(ICCC2022, 2212)
- Jinsoo Ahn, Jeeyoon Kang, Sumin Lee, Jaewoo Kim, Dojin Choi, Jaesoo Yoo, An Analysis of Floating Population and Public Bicycle Usage Patterns in Changwon City(ICCC2022, 2212)
- 김재우, 전찬용, 안동혁, 최도진, 입원 환자 도움 프로그램(UCWIT2022, 2212)
- 강지윤, 안진수, 이수민, 김재우, 최도진, 유니티를 이용한 학습용 콘텐츠 기반 게임 설계(UCWIT2022, 2212)
